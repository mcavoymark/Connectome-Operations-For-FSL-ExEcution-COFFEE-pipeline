#!/usr/bin/env bash 
#!/usr/local/bin/bash #changed back to old shebang 230101

#P0=/home/usr/mcavoy/HCP/scripts/200917GenericfMRIVolumeProcessingPipeline_mm.sh
#START220209
...
#P0=221220GenericfMRIVolumeProcessingPipeline_dircontrol.sh
