...
#P0=/home/usr/mcavoy/HCP/scripts/200305T2wToT1wReg.sh
#P1=/home/usr/mcavoy/HCP/scripts/200305BiasFieldCorrection_sqrtT1wXT1w.sh
#P2=/home/usr/mcavoy/HCP/scripts/200305AtlasRegistrationToMNI152_FLIRTandFNIRT.sh
#START220209
#P0=${HCPMOD}/200305T2wToT1wReg.sh
P0=${HCPMOD}/220217T2wToT1wReg.sh
P1=${HCPMOD}/200305BiasFieldCorrection_sqrtT1wXT1w.sh
#P2=${HCPMOD}/200305AtlasRegistrationToMNI152_FLIRTandFNIRT.sh
P2=${HCPMOD}/220224AtlasRegistrationToMNI152_FLIRTandFNIRT.sh
...
#START200305
startT2=`opts_GetOpt1 "--startT2" $@`
#startAtlasRegistrationToMNI152=`opts_GetOpt1 "--startT2" $@`
#START220502
startAtlasRegistrationToMNI152=`opts_GetOpt1 "--startAtlasRegistrationToMNI152" $@`
...
#START200305
log_Msg "startT2: ${startT2}"
log_Msg "startAtlasRegistrationToMNI152: ${startAtlasRegistrationToMNI152}"
...
#START200306
fi #if [ "startAtlasRegistrationToMNI152" = "FALSE"];then
