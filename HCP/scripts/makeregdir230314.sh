...
helpmsg(){
    ...
    echo "                            Syntax is /STUDYPATH/SUBJDIR/pipeline, e.g. /Users/Shared/10_Connectivity/10_2000/pipeline7.3.2" 
    echo "    -p --pipe -pipe         Optional. Pipeline directory. Default is pipeline7.3.2." 
    echo "                            Syntax is /STUDYPATH/SUBJDIR/<pipeline directory>, e.g. /Users/Shared/10_Connectivity/10_2000/pipeline7.3.2" 
    echo ""
