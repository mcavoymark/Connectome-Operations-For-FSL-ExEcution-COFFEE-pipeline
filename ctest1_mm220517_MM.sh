...
RUNNAME=run3_RH # should be set by creator script
HCPDIR=/Users/bphilip/Documents/HCP # this never gets called - instead, SUBJDIR
OUTDIR=/Users/bphilip/Documents/hcp2feat/output220517_MM/${RUNNAME}/reg # this "reg" dir must be copied into FSL run directory
...
# Mark's "identity"v version
cp -p $FSLDIR/etc/flirtsch/ident.mat ${OUTDIR}/example_func2standard.mat #CHANGED
cp -p $FSLDIR/etc/flirtsch/ident.mat ${OUTDIR}/highres2standard.mat #CHANGED
